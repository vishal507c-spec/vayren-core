...
def ensure_builtin_strategies(data_dir: Path | str | None = None) -> None:
    ...
    # OBR — simplified placeholder
    obr_code = """strategy("OBR")

# OBR — Opening Breakout Range (simplified)
# Migrated from 05_strategy/strategy/builtins/obr.py
# Parameters are edited via UI; logic is provided by the generic runtime for now

ref_index = input(3, "Reference Candle Index")
exit_hour = input(15, "Exit Hour")
exit_min = input(15, "Exit Minute")

# User strategy code goes here
# This is a placeholder migrated from the built-in OBR implementation
"""
    save_strategy(obr_code, "OBR", data_dir)
    # SMA Crossover — placeholder
    sma_code = """strategy("SMA Crossover")

fast_period = input(10, "Fast period")
slow_period = input(30, "Slow period")

# SMA Crossover logic placeholder
# Migrated from 05_strategy/strategy/builtins/sma_crossover.py
"""
