...
| `run_tests.py` | Suite-partitioned pytest driver — har partition apne fresh interpreter mein (suite isolation); `research/tests` samet saare domains | `make test` ke bajaye stable full run ke liye; CI bhi yahi chalata hai |
