...
INPUT_QSS = (
    ...
    " padding: 3px 6px; color: %(text)s; font-size: 11px; selection-background-color: %(accent_dim)s;}"
...
MENU_QSS = (
    ...
    "QMenu::item { padding: 5px 18px 5px 12px; color: %(text2)s; font-size: 11px; border-radius: 2px; }"
